            ...
            <div class="text-gray-700 mb-6">
                <label>
                    ...
                    <input type="text" name="slug" placeholder="post-slug"
                       class="mt-2 bg-white focus:outline-hidden focus:ring-2 focus:ring-teal-500 border border-gray-300 rounded-lg py-2 px-4 block w-full appearance-none leading-normal">
                </label>
