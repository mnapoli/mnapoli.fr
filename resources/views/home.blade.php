        ...
        <div class="max-w-xl pt-6">
            ...
            <div class="mt-6 text-zinc-600 dark:text-zinc-400 prose prose-lg">
                ...
                <p>
                    ...
                    and <a href="https://builder.aws.com/community/@mnapoli">AWS serverless hero</a>.
                </p>
                <p>
                ...
                <ol class="mt-6 space-y-4">
                    <li class="flex gap-4">
                        <div class="relative mt-1 flex h-10 w-10 flex-none items-center justify-center rounded-full shadow-md shadow-zinc-800/5 ring-1 ring-zinc-900/5 dark:border dark:border-zinc-700/50 dark:bg-zinc-800 dark:ring-0 overflow-hidden">
                            <img alt="Null" loading="lazy" decoding="async" data-nimg="1" class="h-7 w-7" style="color: transparent;" src="/images/companies/bref.svg">
                        </div>
                        <dl class="flex flex-auto flex-wrap gap-x-2">
                            ...
                            <dd class="text-xs text-zinc-500 dark:text-zinc-400">Founder / Indie Developer</dd>
                    ...
                    <li class="flex gap-4">
                        <div class="relative mt-1 flex h-10 w-10 flex-none items-center justify-center rounded-full shadow-md shadow-zinc-800/5 ring-1 ring-zinc-900/5 dark:border dark:border-zinc-700/50 dark:bg-zinc-800 dark:ring-0 overflow-hidden">
                            <img alt="Voxie" loading="lazy" decoding="async" data-nimg="1" class="h-6 w-6" style="color: transparent;" src="/images/companies/voxie.svg">
                        </div>
                        <dl class="flex flex-auto flex-wrap gap-x-2">
                            <dt class="sr-only">Company</dt>
                            <dd class="w-full flex-none text-sm font-medium text-zinc-900 dark:text-zinc-100">
                                <a href="https://voxie.com">Voxie</a>
                            </dd>
                            <dt class="sr-only">Role</dt>
                            <dd class="text-xs text-zinc-500 dark:text-zinc-400">Principal Software Engineer</dd>
                            <dt class="sr-only">Date</dt>
                            <dd class="ml-auto text-xs text-zinc-400 dark:text-zinc-500">
